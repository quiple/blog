...
2024년 9월 21일 도쿄 이케부쿠로에 위치한 {선샤인시티}^({{ja|サンシャインシティ}}) 월드 임포트 마트 빌딩 4층 전시홀 A에서 〈[{망가 타임 키라라전 파이널}^({{ja|まんがタイムきらら展FINAL}})](https://www.kiraraten.jp)〉이 개최되었다.
...
스마트폰으로 듣는 특별 음악 콘텐츠 --- 《{봇치 더 록!}^({{ja|ぼっち・ざ・ろっく！}})》 결속밴드의 '키라라 애니송 불러보았다'.
:::
...
QR 코드를 자신의 스마트폰으로 스캔해서 음원을 스트리밍해 전시회를 관람하면서 들을 수 있었다. 링크는 일정 시간 후 만료된다.
