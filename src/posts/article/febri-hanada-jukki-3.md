...
> 2024년 2분기를 석권한 토에이 애니메이션의 오리지널 TV 애니메이션 《걸즈 밴드 크라이({{ja|ガールズバンドクライ}})》. 그 매력을 파헤치는 시리즈 구성 하나다 줏키({{ja|花田十輝}}) 인터뷰의 최종회. 마지막으로는 토게나시 토게아리의 '틀리지 않은' 존재 방식에 대해 다시 한번 생각한다.
