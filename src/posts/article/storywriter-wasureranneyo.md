...
있었죠, 당연히 있었죠. 한번은 우메츠 (타쿠야({{ja|梅津拓也}}) / Ba)가 밴드를 나갈 때 주변에서 부도칸 하자고 그랬던 적이 있어요. 지금 생각하면 그때 했으면 채웠을지도 몰라요.
