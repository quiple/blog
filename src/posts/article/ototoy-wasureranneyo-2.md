...
> 수록곡으로는 〈싸울 때는 혼자야({{ja|戦う時はひとりだ}})〉(〈마이내비 바이트({{ja|マイナビバイト}})〉 CM송의 원곡)나, 〈야간비행({{ja|夜間飛行}})〉(니혼테레비 애니메이션 《더 파이팅 라이징({{ja|はじめの一歩 Rising}})》 OP 테마곡) 등 대중적으로 알려진 곡들이 들어있습니다.
...
이 즈음부터 가사가 안 써지는 일이 종종 생기기 시작했어요. 〈야간비행〉 같은 건 전혀 쓸 수가 없었고. 〈아이 워너비 데어({{ja|アワナビーゼー}})〉나 〈청년 관종({{ja|青年かまってちゃん}})〉도 들으면 괴로워진단 말이죠. 뭔가 곡을 만든다는 행위 자체가 즐겁지 않게 되어가는 느낌이 있어요.
