...
지금의 자신만이 할 수 있는 일을 찾던 소녀가 SNS부(썩은 생선 눈깔 일조량 부족 셔틀런부) 동료들과 함께 동인 게임 제작에 힘쓰는 **《{스텔라의 마법}^({{ja|ステラのまほう}})》**. 2016년 TV 애니메이션화되기도 했던 《{망가 타임 키라라 MAX}^({{ja|まんがタイムきららMAX}})》의 인기 작품이 12월 25일 발매된 단행본 10권으로 피날레를 맞이했습니다.
...
:::figure{src="article/sutemantlb01_w490.png"}
...
소녀들의 빛나는 일상을 전달해 온 키라라 작품들 중에서도 독자적인 세계관을 확립했던 《스텔라의 마법》을, 작가 **{쿠로바 U}^({{ja|くろば・U}}) 선생님**은 어떤 마음으로 그렸는가? 최종회 직전에 진행된 인터뷰를 통해 9년간의 연재를 돌아보았습니다.
...
**쿠로바 U**　앞으로 어떻게 살아갈지 막막하던 시기에 키라라에서 제안이 왔다는 것까지는 [재작년 대담](https://nlab.itmedia.co.jp/cont/articles/3290245/)에서 말씀드린 대로입니다. 그 후 어떤 작품을 그릴지 회의할 때, 담당인 {세코구치}^({{ja|瀬古口}}) 씨가 **"동인 게임 제작 경험을 만화로 그려보는 건 어떠냐"**고 제안해 주셨죠.

::figure{src="article/sutemantlb04_w490.jpg" class="w-100"}
...
> 7권 근처부터 {속표지 그림}^({{ja|扉絵}})에서 인디 게임 패러디가 늘어났죠. 특히 〈{아우터 와일즈}^(Outer Wilds)〉 회차는 "키라라 작품에서 이런 걸?!"이라며 코어 게임 팬들 사이에서 화제가 되었다고 들었습니다.
...
:::figure{src="article/sutemantlb05_w490.png"}
〈아우터 와일즈〉는 정말 최고야.
:::
...
**세코구치**　MAX는 키라라 잡지 중에서도 개성적인 작품들이 많이 모여 있는데, 특히 창간부터 **《{카나메모}^({{ja|かなめも}})》**가 애니메이션화된 2009년경까지 그 경향이 강했습니다. 하지만 2010년대에 들어서며 **《{금빛 모자이크}^({{ja|きんいろモザイク}})》**나 **《{주문은 토끼입니까?}^({{ja|ご注文はうさぎですか？}})》**가 히트하면서, **'역시 MAX도 밝고 귀여운 일상 4컷 만화가 아니면 독자에게 먹히지 않는 것 아닌가'** 하는 분위기가 생기기도 했습니다.
...
:::figure{src="article/sutemantlb08_w490.png" class="max-h-200"}
...
:::figure{src="article/sutemantlb09_w420.png" class="max-h-200"}
...
기술적으로 어렵다기보다, **'대단한 게임을 만들고 싶다!'는 열의가 너무 강한 나머지 {에타루}^({{ja|エタる}})(미완성인 채 끝나다)되는 패턴**이 많은 것 같습니다. 대학 서클에서 처음으로 만들려던 게임이 딱 그랬는데, 체험판까지는 냈지만 결국 완성하지 못한 채 묻혀버리고 말았습니다. 작중에서 시이나도 말했듯이, 규모는 작더라도 끝까지 완성하는 것이 동인 게임 제작에서는 가장 중요하다고 생각합니다.

:::figure{src="article/sutemantlb06_w480.png" class="max-h-200"}
...
:::figure{src="article/sutemantlb07_w420.jpg" class="max-h-200"}
...
:::figure{src="article/sutemantlb10_w420.png" class="max-h-200"}
후배에게 압박을 가하곤 하는 카요.
:::
...
사실은 테루 선배를 이렇게까지 중요한 캐릭터로 만들 예정은 연재 당초 시점엔 없었습니다. **《{유유시키}^({{ja|ゆゆ式}})》**의 유즈코처럼, **언뜻 장난스러워 보이지만 머릿속으로는 여러 생각을 하며 행동하는** 의외성 있는 캐릭터를 제 만화에도 내고 싶다는 생각뿐이었죠.
...
:::figure{src="article/sutemantlb15_w420.jpg" class="max-h-200"}
...
:::figure{src="article/sutemantlb11_w490.png"}
...
어머니를 '비추기({{ja|照}}, 테루)' 위해 태어난 소녀.
:::

> 최종 보스이면서 히로인이기도 하달까요. 〈{두근두근 문예부!}^(Doki Doki Literature Club!)〉의 패러디가 정말 잘 어울립니다.

그 때문에 10권에서는 테루 선배의 과거 이야기가 많아졌는데, 테루 선배가 이야기할 때마다 칸 밖이 **《{관지기 쿠로}^({{ja|棺担ぎのクロ。}})》**처럼 새까맣게 변해서, 독자들을 따돌리고 있는 것은 아닐까 조마조마하며 그렸습니다.
...
> 얼마 전 {아이자키 우타우}^({{ja|相崎うたう}}) 선생님이 그리셨던 내용 그대로였네요...

:::tweet{#1464542229087723523}

> "#magic_of_stella"
> ::figure{src="article/teru.png" class="w-100"}
> --- {{ja|相崎うたう@瑠東さん①発売中}} (@py_py_ai) [2021년 11월 27일](https://x.com/py_py_ai/status/1464542229087723523)
...
>
> --- {{ja|くろば・Ｕ＠ステラのまほう}} (@cloba\_\_\_\_\_U) [2021년 11월 28일](https://x.com/cloba_____U/status/1464749240018944000)
...
:::figure{src="article/sutemantlb03_w490.jpg"}
...
:::figure{src="article/sutemantlb12_w490.jpg"}
...
:::figure{src="article/sutemantlb14_w420.jpg" class="max-h-200"}
