  ...
  main
    ...
    :global(section)
      ...
      :global(.toc)
        ...
        :global(li)
          @apply hover:underline [&.active]:!font-bold [--toc-li-hover-color:var(--color-blue-500)] dark:hover:text-blue-400 [&.active]:hover:!text-current text-sm! mt-2 text-justify
      :global(article)
