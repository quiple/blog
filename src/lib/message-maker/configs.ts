...
export interface RawThemeConfig {
  ...
  bond: {
    ...
    /** 헤더 텍스트 상하 위치 보정치 (언어별) */
    headerOffsetY: LocalizedNumber
    /** 헤더 텍스트 색상 */
    headerColor: string
    /** 헤더 좌측 바 너비 */
...
export function resolveThemeConfig(config: RawThemeConfig, lang: Language): ThemeConfig {
  ...
  return {
    ...
    bond: {
      ...
      headerOffsetY: resolveNum(config.bond.headerOffsetY),
...
export const momotalk: RawThemeConfig = {
  ...
  bond: {
    ...
    buttonShadowHeight: 6,
    buttonShadowBlur: 6,
    buttonShadowSize: 0,
    buttonShadowOpacity: 0.25,
    buttonPaddingTop: {ko: 22, ja: 21, en: 12},
    buttonPaddingRight: {ko: 10, ja: 10, en: 10},
    buttonPaddingBottom: {ko: 12, ja: 13, en: 22},
