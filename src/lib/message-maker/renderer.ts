    ...
    if (msg.type === 'left') {
      ...
      if (themeName === 'momotalk') {
        ...
        drawText(
          ...
          cursorY + config.bond.paddingTop + (headerH - config.bond.headerFontSize) / 2 + config.bond.headerOffsetY,
      ...
      if (msg.type === 'left') {
        ...
        if (themeName === 'momotalk') {
          ...
          svgParts.push(`
            ...
            ${renderSvgText(headerText, bannerX + config.bond.paddingLeft + config.bond.headerBarWidth + config.bond.headerGap, cursorY + config.bond.paddingTop + (headerH - config.bond.headerFontSize) / 2 + config.bond.headerOffsetY, config.bond.headerFont, config.bond.headerFontSize, config.bond.headerColor, 'start', 'hanging', 'normal')}
