...
export const charsetEntries: CharsetEntry[] = [
  // 한글 음절
  {key: 'set2350', label: '2350자', group: '한글 음절', lang: 'ko'},
  {key: 'set2355', label: '2355자', group: '한글 음절', lang: 'ko'},
  {key: 'set2780', label: '2780자', group: '한글 음절', lang: 'ko'},
  {key: 'set4358', label: '4358자', group: '한글 음절', lang: 'ko'},
  {key: 'set11172', label: '11172자', group: '한글 음절', lang: 'ko'},
  // 한자
  {key: 'ks4888', label: 'KS 순서 4888자', group: '한자', lang: 'ko'},
  {key: 'unicode4888', label: 'Unicode 순서 4888자', group: '한자', lang: 'ko'},
  {key: 'jis2965', label: 'JIS 순서 2965자', group: '한자', lang: 'ja'},
  {key: 'unicode2965', label: 'Unicode 순서 2965자', group: '한자', lang: 'ja'},
  {key: 'jis6355', label: 'JIS 순서 6355자', group: '한자', lang: 'ja'},
  {key: 'unicode6355', label: 'Unicode 순서 6355자', group: '한자', lang: 'ja'},
  // EUC-KR
  {key: 'euckr', label: 'EUC-KR', group: 'EUC-KR', lang: 'ko'},
  {key: 'euckrWoHanja', label: '한자 제외', group: 'EUC-KR', lang: 'ko'},
  {key: 'euckrWoHanja2355', label: '한자 제외, 한글 2355자', group: 'EUC-KR', lang: 'ko'},
  {key: 'euckrWoHanja2780', label: '한자 제외, 한글 2780자', group: 'EUC-KR', lang: 'ko'},
  {key: 'euckrWoHanja4358', label: '한자 제외, 한글 4358자', group: 'EUC-KR', lang: 'ko'},
  {key: 'euckrWoHanja11172', label: '한자 제외, 한글 11172자', group: 'EUC-KR', lang: 'ko'},
  // Shift_JIS
