<script lang="ts" module>
  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        default: 'bg-primary border-primary text-primary-foreground hover:bg-primary/80 hover:border-primary/80',
        outline:
        ...
        secondary:
          'bg-secondary border-secondary text-secondary-foreground hover:bg-secondary/80 hover:border-secondary/80 aria-expanded:bg-secondary aria-expanded:border-secondary aria-expanded:text-secondary-foreground',
        ghost:
          'hover:bg-muted hover:border-muted hover:text-foreground aria-expanded:bg-muted aria-expanded:border-muted aria-expanded:text-foreground',
        destructive:
          'bg-destructive/10 border-destructive/10 hover:bg-destructive/20 hover:border-destructive/20 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/20 dark:border-destructive/20 text-destructive focus-visible:border-destructive/40 dark:hover:bg-destructive/30 dark:hover:border-destructive/30',
