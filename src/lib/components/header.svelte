...
<style lang="sass">
  ...
  header
    ...
    section
      ...
      .post-title
        @apply invisible opacity-0 lg:visible lg:opacity-100 transition font-bold line-clamp-2 w-[calc((100%-36px-1rem-36rem)/2-1.5rem)] 2xl:w-[calc((100%-36px-1rem-42rem)/2-1.5rem)]
      :global(.menu)
